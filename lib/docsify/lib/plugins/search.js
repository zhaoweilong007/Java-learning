(function () {
  ...
  function resolveExpireKey(namespace) {
    return namespace ? ((LOCAL_STORAGE.EXPIRE_KEY) + "/" + namespace)
        : LOCAL_STORAGE.EXPIRE_KEY
  }

  function resolveIndexKey(namespace) {
    return namespace ? ((LOCAL_STORAGE.INDEX_KEY) + "/" + namespace)
  ...
  function getAllPaths(router) {
    ...
    Docsify.dom.findAll(
        '.sidebar-nav a:not(.section-link):not([data-nosearch])').forEach(
        function (node) {
          var href = node.href;
  ...
  var install = function (hook, vm) {
    ...
    if (Array.isArray(opts)) {
      ...
      CONFIG.hideOtherSidebarContent = opts.hideOtherSidebarContent
